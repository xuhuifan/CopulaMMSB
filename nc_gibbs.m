...
for i = randperm(dataNum)
    ...
    acceptance_ratio = nc_ar(q_pi, cpi, se_Labels, re_Labels, i, dataNum, Nikt(i,:));
...
for i=randperm(dim3.dataNum)
    for j=randperm(dim3.dataNum)
        ...
        prob_can = indecdf(u22, v22)-indecdf(u11, v22)+indecdf(u11, v11)-indecdf(u22,v11);
